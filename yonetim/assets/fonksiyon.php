...
ob_start();
 try {
 $baglanti=new PDO("mysql:host=localhost;dbname=kurumsalweb;charset=utf8","root","");
...
class yonetim 
{
    ...
    function siteayar($baglanti) {
        ...
        if($_POST):
            ...
            face=?,ints=?,telefonno=?,adres=?,mailadres=?,slogan=?,referansbaslik=?,filobaslik=?,
      ...
      <form action="control.php?sayfa=siteayar" method="post">
        ...
        <div class="row">
        <div class="col-lg-3 border-right pt-3 text-left">
        <span id="siteayarfont">Araçlar Başlık</span>
        </div>
        <div class="col-lg-9 p-1">
    ...
    function aracfilo($vt){
        ...
        <div class="col-lg-12">
        <h4 class="float-left mt-3 text-info mb-2">
        <a href="control.php?sayfa=aracfiloekle" class="ti-plus bg-success p-1 text-white mr-2 mt-3"></a>
        Araç Resimleri</h4> </div>';
    ...
    while($sonbilgi=$introbilgiler->fetch(PDO::FETCH_ASSOC)):
        ...
        <a href="control.php?sayfa=aracfilosil&id='.$sonbilgi["id"].'" class="ti-trash m-2 text-danger" style="font-size:20px;"></a>
        </kbd>
        </div>
                ...
                if($_FILES["dosya"]["size"]>(1024*1024*5)):
                    ...
                    if(!in_array($_FILES["dosya"]["type"],$izinverilen)):
                       ...
                       header("refresh:2,url=control.php?sayfa=aracfiloekle");
                        ...
                        $dosyaminyolu2=str_replace('../','',$dosyaminyolu);
                        $kayıtekle=self::sorgum($vt,"insert into filomuz (resimyol) VALUES('$dosyaminyolu2')",0);
                    endif;
                endif; 
        endif;
    ...
    function aracfiloguncelleme($vt){
        ...
        if($_POST):
            ...
            if($_FILES["dosya"]["name"]==""):
             ...
             <div class="card card-bordered">
             <div class="card-body">
             <h5 class="title border-bottom">araç resim güncelleme formu</h5>
             <form action="" method="post" enctype="multipart/form-data">
             <p class="card-text">
             <input type="file" name="dosya" /></p>
             <p class="card-text">
